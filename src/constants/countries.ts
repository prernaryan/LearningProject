...
function addPlusAndCountryCdToPhoneNumbers(countries: Country[]): Country[] {
  return countries
    .map(country => ({
      ...country,
      phone: `+${country.phone}`,
...
export const countriesArray: Country[] = addPlusAndCountryCdToPhoneNumbers(
  Object.entries(countries).map(([countryCd, country]) => ({
    ...country,
    country_Cd: countryCd,
  })),
);
export const indiaObject: Country = {
  capital: 'New Delhi',
  continent: 'AS',
  country_Cd: 'IN',
  currency: 'INR',
